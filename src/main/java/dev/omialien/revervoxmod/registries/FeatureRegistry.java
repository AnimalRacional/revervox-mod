...
import dev.omialien.revervoxmod.worldgen.feature.EchoTrapFeature;
...
public class FeatureRegistry {
    ...
    public static final RegistryObject<EchoTrapFeature> ECHO_TRAP_FEATURE =
            FEATURES.register("echo_trap_feature", () -> new EchoTrapFeature(NoneFeatureConfiguration.CODEC));
