...
abstract public class AbstractEchoDarkFeature extends Feature<NoneFeatureConfiguration> {
    private final List<ResourceLocation> PIECES;
    private final int MAX_HEIGHT_VARIANCE;

    public AbstractEchoDarkFeature(Codec<NoneFeatureConfiguration> codec, List<ResourceLocation> pieces, int heightVariance) {
        super(codec);
        PIECES = pieces;
        MAX_HEIGHT_VARIANCE = heightVariance;
    }
