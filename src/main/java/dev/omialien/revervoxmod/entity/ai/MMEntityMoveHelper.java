...
public class MMEntityMoveHelper extends MoveControl {
    ...
    public void tick() {
        if (this.operation == Operation.STRAFE) {
            float f = (float) this.mob.getAttributeBaseValue(Attributes.MOVEMENT_SPEED);
            ...
            float f9 = (float) (Mth.atan2(d1, d0) * (180D / Mth.PI)) - 90.0F;
            ...
            this.mob.setSpeed((float) (this.speedModifier * this.mob.getAttributeBaseValue(Attributes.MOVEMENT_SPEED)));
